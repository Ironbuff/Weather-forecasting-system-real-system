...
# Load the dataset
dataset = pd.read_csv(r"C:\Users\Lenovo\PycharmProjects\final\.venv\static\combined_file.csv")

# Select the features and target variable
features = dataset[['DISTRICT','LAT', 'LON', 'PRECTOT', 'PS', 'QV2M', 'RH2M', 'T2MWET','T2M_MAX','T2M_MIN','T2M_RANGE','WS10M_MAX','WS10M_MIN', 'TS', 'WS10M', 'WS50M']]
target = dataset['T2M']
